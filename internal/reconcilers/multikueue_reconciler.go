...
//
//func (r *MultiKueueReconciler) ReconcileSecrets(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
//	if err := yaml.Unmarshal(manifest.SpokeManifest, &spokeClusterRole); err != nil {
...
//}
//
//func (r *MultiKueueReconciler) ensureKueueOperator(ctx context.Context, client *kubernetes.Clientset, ns, sa string) error {
//	secret := &corev1.Secret{
//		ObjectMeta: metav1.ObjectMeta{
//			Name:        sa + "-token",
//			Annotations: map[string]string{"kubernetes.io/service-account.name": sa},
